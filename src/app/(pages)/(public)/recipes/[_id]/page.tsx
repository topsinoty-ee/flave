...
//   const recipe = await fetchRecipe(_id);
...
// async function fetchRecipe(_id: string): Promise<Recipe> {
//   const res = await fetch(`${process.env.BACKEND_URL}/recipes/${_id}`);
//   if (!res.ok) throw new Error("Failed to fetch recipe");
//   const { data } = await res.json();
//   if (!isRecipe(data)) throw new Error("Invalid recipe data");
//   return data;
// }
...
// //       {/* Top Row: Image + Info */}
// //       <div className="flex gap-10 w-full aspect-section-md">
...
// //         </div>
// //       </div>
// //       <div className="flex w-full bg-black outline-yellow outline-1 aspect-section-sm rounded-lg gap-15 p-20">
