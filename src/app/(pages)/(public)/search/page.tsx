      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="relative">
          <input
            ...
            className="w-full p-4 text-lg transition-all duration-200 border-2 border-gray-200 shadow-sm rounded-xl focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
          />
        ...
        {results.length > 0 ? (
          <div className="space-y-4">
            ...
            <ul className="bg-white divide-y divide-gray-200 rounded-lg shadow-lg">
