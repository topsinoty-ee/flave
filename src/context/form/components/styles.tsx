...
export const errorStyles = "border-error focus:ring-2 focus:ring-error-light";
export const validStyles =
  "border-success focus:ring-2 focus:ring-success-light";
export const disabledStyles = "bg-gray-200 cursor-not-allowed";
