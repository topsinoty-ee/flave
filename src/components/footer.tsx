...
export const Footer = () => (
    <footer className="flex md:flex-row flex-col w-full constainer  gap-10 mx-0 px-5 py-10 md:p-10 md:py-15 lg:p-20 text-gray-200 bg-black text-white min-h-[40%] max-h-96 place-content-between">
        ...
        <section className={`md:flex hidden gap-20 max-w-max`}>
